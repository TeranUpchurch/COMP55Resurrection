...
// this class handles the loss menu and when the player loses the game

public class LossMenu extends PopupMenu{
	...
	public LossMenu(String imagePath, MainApplication mainApp, GameTimer gameTimer, GameScene gameScene)
	{
		...
		this.lossMenu = new GImage(filename1);
		this.biggerRestartButton = drawRestartButton("button_restart_bigger", lossMenu);
		this.biggerLevelMenuButton = drawLevelMenuButton("button_levelMenu_bigger", lossMenu);
		this.biggerExitButton = drawExitButton("button_exit_bigger", lossMenu);		
