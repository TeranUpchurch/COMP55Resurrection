...
public class Level {
	...
	public Level(GameScene gameScene, String difficulty)
	{
		...
		if (difficulty == "Easy")
		{
			...
			robots2.add(new RobotGreen(1, gameScene));
		...
		else if (difficulty == "Medium")
		{
			...
			ArrayList<Robot> robots3 = new ArrayList<Robot>();
			robots3.add(new RobotGrey(0, gameScene));
			robots3.add(new RobotGreen(1, gameScene));
			robots3.add(new RobotYellow(2, gameScene));
			robots3.add(new RobotGreen(3, gameScene));
			robots3.add(new RobotGrey(4, gameScene));
			ArrayList<Integer> intervals3 = new ArrayList<Integer>();
			intervals3.add(10);
			intervals3.add(10);
			intervals3.add(10);
		...
		{
			ArrayList<Robot> robots1 = new ArrayList<Robot>();
			robots1.add(new RobotGreen(0, gameScene));
			robots1.add(new RobotGreen(2, gameScene));
			robots1.add(new RobotGreen(3, gameScene));
			robots1.add(new RobotGreen(0, gameScene));
			robots1.add(new RobotGreen(2, gameScene));
			...
			robots2.add(new RobotGreen(0, gameScene));
			robots2.add(new RobotGreen(2, gameScene));
			robots2.add(new RobotGreen(3, gameScene));
			robots2.add(new RobotGrey(0, gameScene));
			robots2.add(new RobotGrey(2, gameScene));
			robots2.add(new RobotGrey(2, gameScene));
			robots2.add(new RobotYellow(1, gameScene));
			...
			ArrayList<Robot> robots3 = new ArrayList<Robot>();
			robots3.add(new RobotGrey(0, gameScene));
			robots3.add(new RobotGrey(1, gameScene));
			robots3.add(new RobotRed(2, gameScene));
			robots3.add(new RobotGrey(3, gameScene));
			robots3.add(new RobotGrey(2, gameScene));
			ArrayList<Integer> intervals3 = new ArrayList<Integer>();
			intervals3.add(10);
			intervals3.add(10);
			intervals3.add(10);
